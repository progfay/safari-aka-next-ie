...
import {
  isSupportedBy,
  isSupportedByModernBrowsersOtherThanSafari,
} from "./browser";
...
function visitIdentifier(path: string, identifier: Identifier): void {
  ...
  if (
    ...
    (!isSupportedBy(__compat, "safari") ||
      !isSupportedBy(__compat, "safari_ios")) &&
    isSupportedByModernBrowsersOtherThanSafari(__compat)
  ) {
